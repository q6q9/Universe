...
int main() {
    ...
    for (;;) {
        ...
        switch (y) {
            case 1:
                for (;;) {
                    cinx(x, "Выберите действие:", 4, "Отобразить текущие кинотеатры",
                         "Отобразить сведения кинотеатра по ключу",
                    ...
                    switch (x) {
                        ...
                        case 4: {
                            cinx(x, "Выберите действие:", 3, "Добавить кинотеатр", "Удалить кинотеатр",
                                 "Изменить кинотеатр");
                            switch (x) {
                                case 1: {
                                ...
                                case 2: {
                                    for (;;) {
                                        int j;
                                        int x = rand(10);
                                        cinx(j, "Введите ключ кинотеатра, который вы хотите удалить или -1 для выхода:");
                                        if (j == -1) {
                                            cls();
                                            break;
                                        }
                                        for (auto it = cinemas.begin(); it < cinemas.end(); it++) {
                                            if ((*it).id == j) {
                                                out.put("Кинотеатр который вы хотите удалить:");
                                                (*it).show();
                                        ...
                                        if (j != -1337)
                                            out.put("Кинотеатр не был найден");
                                    }
                                    break;
                                }
                                case 3: {
                                    int j,i;
                                    Cinema a(0);
                                    out.put("Введите ID кинотеатра или -1, чтобы вернуться");
                                    r_cin(j);
                                    if(j==-1)break;
                                    for(Cinema &a:cinemas){
                                        if (j==a.id) j=-1337;
                                    }
                                    if(j==-1337){ print("Кинотеатра с данным ID  не существует"); break;}
                                    cinx(j, "Выберите свойство, которое надо изменить :",
                                         7,  "Название кинотеатра", "Кол-во залов", "Кол-во мест", "Адрес",
                                         "Категория", "Состояние", "ID репертуаров");
                                    if (j == 0) {
                                        cls();
                                        break;
                                    ...
                                    if (j == 7) {
                                        out.put("Введите состояние (1 - работает, 0 - не работает):");
                                        r_cin(i);
                                        a.state = (i == 1);
                                    }
                                    if (j == 8) {
                                            ...
                                            if (films[i].id == j) {
                                                ...
                                                for (;;) {
                                                    cinx(x, "Выберите свойства для его замены:", 6, "Название фильма",
                                                         "Название студии", "Продюсеры", "Операторы", "Жанры",
                                                         "Актеры");
                                                    if (x == 0)
                                                        break;
                                                    if (x == 1) {
            ...
            case 3:
                for (;;) {
                    cinx(x, "Выберите действие:", 4, "Отобразить текущие репертуары",
                         "Отобразить сведения репертуара по ключу",
                    ...
                    switch (x) {
                        ...
                        case 4: {
                            cinx(x, "Выберите действие:", 3, "Добавить реперутар", "Удалить реперутар",
                                 "Изменить реперутар");
                            switch (x) {
                                case 1: {
                                ...
                                case 2: {
                                    for (;;) {
                                        ...
                                        int x = rand(10);
                                        cinx(j,
                                             "Введите ключ репертуара, который вы хотите удалить или -1 для выхода:");
                                        if (j == -1) {
                                            cls();
                                            break;
                                        }
